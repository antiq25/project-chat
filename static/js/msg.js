var app = {
    ...
    topNav: {
      id: "#top-nav",
      class: "app-top-nav",
      mobile: { toggleAttr: 'data-toggle="app-top-nav-mobile"' },
      menu: {
        class: "menu",
        itemClass: "menu-item",
        itemLinkClass: "menu-link",
    ...
    init: { attr: "data-init", class: "app-init" },
    animation: {
      attr: "data-animation",
  ...
  handleScrollbar = function () {
    "use strict";
    for (
      var e = document.querySelectorAll("[" + app.scrollBar.attr + "]"), t = 0;
      t < e.length;
      t++
    )
    ...
    e.scrollbarInit ||
      ...
      app.isMobile
        ...
        : ((t =
          ...
          0 !== e.closest("." + app.sidebar.class).length
  ...
  handleSidebarMenuToggle = function (a) {
    a.map(function (e) {
      e.onclick = function (e) {
        ...
        e.classList.contains(app.sidebar.menu.expandClass) ||
        (e.classList.contains(app.sidebar.menu.activeClass) && !t.style.display)
          ? (e.classList.remove(app.sidebar.menu.expandClass),
            (t.style.display = "none"))
          : (e.classList.add(app.sidebar.menu.expandClass),
  ...
  handleSidebarMenu = function () {
    ...
    a = [].slice.call(
      document.querySelectorAll(e + t + " > ." + app.sidebar.menu.itemLinkClass)
    );
    handleSidebarMenuToggle(a);
    a = [].slice.call(
      document.querySelectorAll(
        e + t + t + " > ." + app.sidebar.menu.itemLinkClass
      )
    );
    handleSidebarMenuToggle(a);
  },
  ...
  handleCardAction = function () {
    ...
    [].slice
      .call(document.querySelectorAll("[" + app.card.expand.toggleAttr + "]"))
      .map(function (e) {
        return (
          (e.onclick = function (e) {
            e.preventDefault();
            ...
            document.body.classList.contains(t) && e.classList.contains(t)
              ? (e.removeAttribute("style"),
                e.classList.remove(t),
                document.body.classList.remove(t))
              : (document.body.classList.add(t), e.classList.add(t)),
  ...
  handleScrollToTopButton = function () {
    ...
    (document.onscroll = function () {
      var e = document.documentElement,
        ...
        e =
          (a.map(function (e) {
            t >= app.scrollToTopBtn.heightShow
              ? e.classList.contains(app.scrollToTopBtn.showClass) ||
                e.classList.add(app.scrollToTopBtn.showClass)
              : e.classList.remove(app.scrollToTopBtn.showClass);
          }),
  ...
  handleScrollTo = function () {
    [].slice
      .call(document.querySelectorAll("[" + app.scrollTo.attr + "]"))
      .map(function (a) {
        a.onclick = function (e) {
          e.preventDefault();
          var e = a.getAttribute(app.scrollTo.target)
  ...
  handleToggleClass = function () {
    [].slice
      .call(document.querySelectorAll("[" + app.toggleClass.toggleAttr + "]"))
      .map(function (e) {
        e.onclick = function (e) {
          e.preventDefault();
  ...
  handleThemePanel = function () {
    ...
    var e, t;
    [].slice
      .call(document.querySelectorAll("[" + app.themePanel.toggleAttr + "]"))
      .map(function (e) {
        e.onclick = function (e) {
          e.preventDefault();
          ...
          e.classList.contains(app.themePanel.activeClass)
            ...
            : (e.classList.add(app.themePanel.activeClass), (t = !0)),
            Cookies && Cookies.set(app.themePanel.cookieName, t);
        };
      }),
      !Cookies ||
        ("true" != (e = Cookies.get(app.themePanel.cookieName)) &&
          void 0 !== e) ||
        ((e = document.querySelector("[" + app.themePanel.toggleAttr + "]")) &&
          e.click()),
      [].slice
        .call(
          document.querySelectorAll(
          ...
          e.onclick = function (e) {
            ...
            for (
              var t = document.querySelector("html"),
                a = this.getAttribute(app.themePanel.themeCover.classAttr),
                o = 0;
              o < document.documentElement.classList.length;
              o++
            ) {
            ...
            a && t.classList.add(a),
              [].slice
                ...
                .map(function (e) {
                  e.getAttribute(app.themePanel.themeCover.toggleAttr) != a &&
                    e
                      .closest("." + app.themePanel.themeCoverItemClass)
                      .classList.remove(app.themePanel.themeCover.activeClass);
                }),
              this.closest(
                "." + app.themePanel.themeCoverItemClass
              ).classList.add(app.themePanel.themeCover.activeClass),
        ...
        .call(
          document.querySelectorAll(
            "." +
              app.themePanel.class +
              " [" +
              app.themePanel.themeMode.toggleAttr +
              "]"
          )
        )
        .map(function (e) {
          e.onclick = function (e) {
            e.preventDefault();
            var t = this,
              e = t.getAttribute(app.themePanel.themeMode.valueAttr)
                ? t.getAttribute(app.themePanel.themeMode.valueAttr)
                : "";
            "dark" == e
              ? document
                  .querySelector("html")
                  .setAttribute(app.themePanel.themeMode.attr, e)
              : document
                  .querySelector("html")
                  .removeAttribute(app.themePanel.themeMode.attr),
              ...
              [].slice
                ...
                .map(function (e) {
                  e != t &&
                    e.classList.remove(app.themePanel.themeMode.activeClass);
                }),
              handleCssVariable(),
      ...
      Cookies &&
        Cookies.get(app.themePanel.themeMode.cookieName) &&
        (t = document.querySelector(
          "." +
            app.themePanel.class +
            " [" +
            app.themePanel.themeMode.toggleAttr +
            "][" +
            app.themePanel.themeMode.valueAttr +
            '="' +
            Cookies.get(app.themePanel.themeMode.cookieName) +
            '"]'
        )) &&
  ...
  handleUnlimitedTopNavRender = function () {
    ...
    function t(e, t) {
      var a = e.closest("." + app.topNav.menu.class),
        ...
        r =
          ...
          2 * document.querySelector("." + app.topNav.class).clientHeight,
        n = 0,
        i = 0,
    ...
    function a() {
      ...
      i &&
        ...
        (n =
          "rtl" ==
          (e = window.getComputedStyle(document.body)).getPropertyValue(
            "direction"
          )
            ? "margin-right"
            : "margin-left"),
        ...
        a != o && t <= o
          ? (r.classList.add(app.topNav.control.showClass), (s += n))
          : r.classList.remove(app.topNav.control.showClass),
        (r = i.querySelector(
          "." +
            app.topNav.control.class +
            "." +
        ...
        t <= a && t <= o
          ? r.classList.add(app.topNav.control.showClass)
          : r.classList.remove(app.topNav.control.showClass),
        t <= a) &&
        ((n = a - t + s),
        "rtl" != e.getPropertyValue("direction")
          ? (i.style.marginLeft = "-" + n + "px")
          : (i.style.marginRight = "-" + n + "px"));
    }
      ...
      if (r) {
        ...
        e.forEach((e) => {
          ...
          r.addEventListener("mousedown", (e) => {
            (o = !0),
              (t = e.pageX),
              (a = n.style.marginLeft ? parseInt(n.style.marginLeft) : 0),
              (l = r.offsetWidth - s);
          }),
  ...
  handleTopNavToggle = function (a, o = !1) {
    a.map(function (e) {
      e.onclick = function (e) {
        var t;
        e.preventDefault(),
          (!o || document.body.clientWidth < app.breakpoints.md) &&
  ...
  handleTopNavSubMenu = function () {
    ...
    a = [].slice.call(
      document.querySelectorAll(e + t + " > ." + app.topNav.menu.itemLinkClass)
    );
